                ...
                <div class="container d-flex align-items-center justify-content-lg-between position-relative">
                    ...
                    <div class="collapse navbar-collapse justify-content-center">
                        <ul class="nav col-12 col-md-auto justify-content-center main-menu">
                            ...
                            <li><a href="#" class="nav-link">Preço</a></li>                            
                        </ul>
                    </div>
            ...
            <div class="row justify-content-center">
                    <div class="col-md-10 col-lg-6 mt-5">
                        <div class="section-heading text-center" data-aos="fade-up">
                            <h3>Empresas que confiaram em nós</h3>
                        </div>
                    </div>
                </div>
                <div class="row justify-content-center">
                ...
                <div class="row align-items-center justify-content-between">
                    <div class="col-lg-5 col-md-12">
                        <div class="section-heading" data-aos="fade-up">
                            <h4 class="h5 text-primary">O que fazemos?</h4>
                            <h2>Solução poderosa para suas necessidades de negócios</h2>
                            <p>Quickly incubate functional channels with multidisciplinary architectures authoritatively fabricate.</p>
